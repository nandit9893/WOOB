...
const Hero = () => {
  ...
  return (
    <div className="h-full my-20 mx-auto sm:p-0 p-3 flex flex-col items-center justify-center">
      <p className="sm:w-[450px] w-72 text-center sm:text-xl text-xs rounded-xl font-semibold bg-gray-400 sm:p-2 p-1 text-white my-1">Automate Barter Campaigns with AI for 7 days</p>
