    ...
    <div className="my-2 flex flex-col items-center gap-4 justify-center mx-auto w-[90%] rounded-2xl sm:p-20 p-5">
      ...
      <div className="flex flex-col sm:flex-row gap-24 my-10 w-full">
        <div className="w-1/4 flex gap-5 flex-col">
          ...
          <div className="flex gap-5 items-center">
            <img className="w-16 h-16" src="https://cdn.prod.website-files.com/6716c18e45760446b740a31c/6716f02792d8e7fb7011fe80_g2%20badge.png" alt="" />
        ...
        <div className="w-3/4 flex flex-col sm:flex-row justify-between gap-4">
          <div className="flex flex-col gap-3 sm:w-1/4 w-full">
            ...
            <p className="text-lg font-normal text-gray-600">Automated Campaign Manager</p>
          ...
          <div className="flex flex-col gap-3 sm:w-1/4 w-full">
            ...
            <p className="text-lg font-normal text-gray-600">Aspire vs. Wobb</p>
            <p className="text-lg font-normal text-gray-600">Grin vs. Wobb</p>
            <p className="text-lg font-normal text-gray-600">HypeAuditor vs. Wobb</p>
            <p className="text-lg font-normal text-gray-600">Traackr vs. Wobb</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col-reverse sm:flex-row justify-between w-full sm:gap-0 gap-10">
        <div className="flex gap-3">
          ...
          <p className="text-lg font-medium text-gray-500">Policy</p>
        </div>
        <div className="flex gap-8">
          <a href="https://www.facebook.com/WobbHQ/" target="_blank">
          ...
          <a href="https://www.instagram.com/wobb.ai/" target="_blank">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-blue-600">
          ...
          <a href="https://x.com/wobbhq" target="_blank">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-blue-600">
          ...
          <a href="https://www.linkedin.com/company/wobbhq/posts/?feedView=all" target="_blank">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-blue-600">
