    ...
    <div className="flex flex-col my-20">
      ...
      <p className="text-xl text-gray-500 text-center my-2">Everything you need to know about the product and billing.</p>
      {
        supports.map((support) => (
          <div onClick={()=>setMenuRefernce(support)} className="flex flex-col mt-10 justify-center items-center mx-80 gap-10" key={support._id}>
      ...
      <div className="my-10 flex flex-col items-center gap-4 justify-center mx-auto w-[80%] bg-slate-100 rounded-2xl p-20">
        <p className="text-2xl text-black font-bold">Start your free trial</p>
        <p className="text-xl font-semibold text-gray-500">Can't find the answer you're looking for? Please chat to our friendly team.</p>
